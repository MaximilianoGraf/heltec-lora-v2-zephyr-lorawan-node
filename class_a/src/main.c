...
#define LORAWAN_JOIN_EUI		{ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,\
					  0x00, 0x00 }
//#define LORAWAN_APP_KEY			{ 0x99, 0x54, 0xe9, 0xf3, 0x10, 0x43,\
					  0xe7, 0x51, 0xa0, 0xd0, 0xc0, 0x86,\
					  0xa8, 0x5a, 0x85, 0x92 }
...
/*******************************/
//#define LORAWAN_DEV_EUI			{ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,\
					  0x00, 0x00 }

// #define LORAWAN_APP_KEY			{ 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,\
...
int main(void)
{
	...
	{
		LOG_ERR("lorawan_set_region EU868 succeded");
	}
	...
	// join_cfg.abp.dev_addr=0;
	// join_cfg.abp.app_skey=0;
	// join_cfg.abp.nwk_skey=0;
	// join_cfg.abp.app_eui=0;
